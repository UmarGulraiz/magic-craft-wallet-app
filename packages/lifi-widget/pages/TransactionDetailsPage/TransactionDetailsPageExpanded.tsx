    ...
    >
        ...
        >
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M0.292893 1.11711C0.683417 0.726588 1.31658 0.726588 1.70711 1.11711L6 5.41001L10.2929 1.11711C10.6834 0.726588 11.3166 0.726588 11.7071 1.11711C12.0976 1.50764 12.0976 2.1408 11.7071 2.53133L7.41421 6.82422L11.7071 11.1171C12.0976 11.5076 12.0976 12.1408 11.7071 12.5313C11.3166 12.9219 10.6834 12.9219 10.2929 12.5313L6 8.23843L1.70711 12.5313C1.31658 12.9219 0.683417 12.9219 0.292893 12.5313C-0.0976311 12.1408 -0.0976311 11.5076 0.292893 11.1171L4.58579 6.82422L0.292893 2.53133C-0.0976311 2.1408 -0.0976311 1.50764 0.292893 1.11711Z"
              fill="white"
            />
          </svg>
        </div>
      ...
      >
        ...
        >
          ...
          {routeExecution ? (
            <div style={{ marginLeft: "auto" }}>
              {getTxStatus(routeExecution?.status)}
            </div>
          ) : null}
        </Box>
        ...
        <Card mt={2} sx={{ background: "transparent", border: "none" }}>
          ...
          >
            ...
            >
              ...
              >
                <path
                  d="M8.4 12.3242H1.2C0.537258 12.3242 0 11.787 0 11.1242V3.92422H1.2V11.1242H8.4V12.3242ZM10.8 9.92422H3.6C2.93726 9.92422 2.4 9.38696 2.4 8.72422V1.52422C2.4 0.861477 2.93726 0.324219 3.6 0.324219H10.8C11.4627 0.324219 12 0.861477 12 1.52422V8.72422C12 9.38696 11.4627 9.92422 10.8 9.92422ZM3.6 1.52422V8.72422H10.8V1.52422H3.6Z"
                  fill="#F3F9F4"
                />
              </svg>
              <Typography
        ...
        <Box mt={1}>
          ...
          >
            Magiccraft leverages the advanced Li.Fi swap functionality for
        ...
        <Box mt={1}>
          ...
          <Button
            sx={{ borderRadius: "6px", width: "100%", marginTop: "8px" }}
